        ...
        <View style={styles.container}>
            <ScrollView>
                <View>
                    ...
                    {providerData[id].discount &&
                        <View style={styles.view1}>
                            <Text style={styles.text1}>GET {providerData[id].discount}% OFF ON FOOD TOTAL</Text>
                        </View>
                    }
                    <View style={styles.view2}>
                        ...
                        <View style={styles.view5}>
                            ...
                            <View style={styles.view7}>
                                <Text style={styles.text7}>{providerData[id].collectTime}</Text>
                        ...
                        <View style={styles.view8}>
                            ...
                            <View style={styles.view9}>
                                <Text style={styles.text9}>{providerData[id].deliveryTime}</Text>
