...
export const menuDetailedData = [
    {
        ...
        preferenceData: [
            [
                ...
                { name: "Te Te Bong Dip", price: 8.75, checked: false, id: 11 },
                { name: 'Non RVN Dip', price: 11.99, checked: false, id: 12 },
            ],

            [
                { name: "Small Card", price: 8.90, checked: false, id: 13 },
                { name: "Small CD Album", price: 8.90, checked: false, id: 14 },
                { name: 'Small mini sticker', price: 11.90, checked: false, id: 15 },
                { name: 'Small Non RV', price: 3.95, checked: false, id: 16 },
                { name: 'Small Head', price: 3.95, checked: false, id: 17 },
                { name: 'Small Apple', price: 10.95, checked: false, id: 18 },
                { name: 'Small Strawberry Shake', price: 16.95, checked: false, id: 19 },
                { name: 'Small Chocolate Shake', price: 16.95, checked: false, id: 20 },
            ],

            [
                { name: "Small Coke", price: 8.90, checked: false, id: 21 },
                { name: "Small Fanta Orange", price: 8.90, checked: false, id: 22 },
                { name: 'Small Sprite', price: 11.90, checked: false, id: 23 },
            ...
            [
                { name: "debonairs sauce", price: 8.90, checked: false, id: 30 },
                { name: "BBQ Sauce", price: 8.90, checked: false, id: 31 },
                { name: 'Tikka Sauce', price: 11.90, checked: false, id: 32 },
            ],

            [
                { name: "Small Coke", price: 8.90, checked: false, id: 33 },
                { name: "Small Fanta Orange", price: 8.90, checked: false, id: 34 },
                { name: 'Small Sprite', price: 11.90, checked: false, id: 35 },
